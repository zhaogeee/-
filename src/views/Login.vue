        ...
        <div class="forms-container">
            <div class="signin-signup">
                <div class="form sign-in-form">
                    ...
                    <input type="submit" @click="loginHandle" class="btn" value="登录" />
                </div>
                <div class="form sign-up-form">
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" v-model="rePassword" placeholder="重复密码 *" />
                    </div>
                    <input
                            type="submit"
        ...
        setup() {
            ...
            const loginHandle = async () => {
                if (tel.value && password.value) {
                    // sessionStorage.setItem('AccountToken',"1")
                    // router.push("/Homepage");
                    const result = await login({account:tel.value,password:password.value});
                    // console.log(result);
                    
                    if(result.code == 200){
                        // let token = result.data;
                        // console.log("---loginHandle---",UserBasicInfo)
                        sessionStorage.setItem('account',tel.value);
                        sessionStorage.setItem('AccountToken',result.data.token)
            ...
            const registerHandle = async () => {
                if(password.value === rePassword.value){
                    if(tel.value && password.value && email.value){
